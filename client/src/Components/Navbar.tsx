  ...
  return (
    <div className="bg-white border-b border-gray-200 shadow-sm flex flex-row items-center ">
      ...
      <div className="flex flex-row gap-3 justify-start w-full">
        <a className="px-4 hover:text-blue-400 text-gray-700 cursor-pointer">Map</a>
        <a className="px-4 hover:text-blue-400 text-gray-700 cursor-pointer">Tours</a>
        <a href="/login" className="ml-auto px-4 hover:text-blue-400 text-gray-700 cursor-pointer">Login</a>
      </div>
