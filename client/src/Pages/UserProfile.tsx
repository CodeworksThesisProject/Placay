...
const UserProfile: React.FC = () => {
  ...
  const [coordinates] = useState<[number, number]>([51.5072178, -0.1275862]);
  const [searchedCity] = useState<string>("London");
  ...
  <div className="grid grid-cols-[20%_80%] px-15 h-full">
    ...
    <div className="bg-blue-500 py-5 text-white flex flex-col gap-5 justify-start items-center">
      ...
      <div className="menu mt-10 flex flex-col w-full pl-[30%]">
    ...
    <div className=" bg-gray-100 px-10 py-5">
      ...
      <div className={`tour flex flex-row flex-wrap gap-5 justify-start ${profileActive? 'hidden': ''}`}>
