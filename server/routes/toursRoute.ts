...
import { addNewTour, deleteTours, editTours, getAllTours, getTourById, getTours, likedTours } from "../controllers/tourController";
import { asyncHandler } from "../middleware/asyncHandler";
import { authMiddleware } from "../middleware/authMiddleware";
const router = express.Router();

router.get('/tours', asyncHandler(getAllTours));
router.get('/like/:userId/:tourId', authMiddleware, asyncHandler(likedTours));
